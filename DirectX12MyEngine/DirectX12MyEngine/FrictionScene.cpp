...
void FrictionScene::Initialize()
{
	...
	objSphere = FrictionSphere::Create(modelSphere);
...
void FrictionScene::Update()
{
	...
	//デバックテキスト
	//X座標,Y座標,縮尺を指定して表示
	debugText->Print("FrictionSphere", 100, 50);
	debugText->Print("SPACE KEY:Reset", 100, 100);
	debugText->Print("ENTER KEY:AirResistance", 100, 120);
