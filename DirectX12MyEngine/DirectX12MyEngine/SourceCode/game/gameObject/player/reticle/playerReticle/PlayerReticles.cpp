...
{
	//レティクルを生成
	nearReticle.reset(PlayerNearReticle::Create(SpriteTextureLoader::Reticle, 15.0f, { 100, 100 }));
	farReticle.reset(PlayerFarReticle::Create(SpriteTextureLoader::Reticle, 25.0f, { 50, 50 }, { 100, 100 }));
