...
/// メダマーン(本体)
/// </summary>
class MedamanMainBody : public ObjObject3d
{
private: //攻撃内容ごとのフェーズ
...
public: //静的メンバ関数
	...
	//getter
	static const int GetMaxHP() { return MedamanMainBody::maxHP; }
	static const Vector3& GetNormalSize() { return MedamanMainBody::normalSize; }

	//setter
	static void SetStageScene(BaseStageScene* stageScene) { MedamanMainBody::stageScene = stageScene; }
	static void SetMedamanMainBodyModel(ObjModel* model) { MedamanMainBody::mainBodyModel = model; }
	static void SetMedamanMainBodyDamageModel(ObjModel* model) { MedamanMainBody::mainBodyDamageModel = model; }
	static void SetMedamanMainBodySleepModel(ObjModel* model) { MedamanMainBody::mainBodySleepModel = model; }
	static void SetMedamanMainBodyDeadModel(ObjModel* model) { MedamanMainBody::mainBodyDeadModel = model; }
	static void SetBulletModel(ObjModel* model) { MedamanMainBody::bulletModel = model; }
...
private: //静的メンバ変数
	...
	//攻撃内容:追従の行動遷移
	static void (MedamanMainBody::* attackTypeTrackingPhaseFuncTable[])();
	//攻撃内容:超巨大弾の行動遷移
	static void (MedamanMainBody::* attackTypeSuperGiantBulletPhaseFuncTable[])();
	//攻撃内容:回転の行動遷移
	static void (MedamanMainBody::* attackTypeRotatePhaseFuncTable[])();
